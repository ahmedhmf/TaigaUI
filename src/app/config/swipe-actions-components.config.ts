...
export const swipeActionsComponents: Omit<ComponentStructure, 'id'>[] = [
  {
    ...
    description: 'Swipe Actions Basic',
  ...
  },
  {
    ...
    description: 'Swipe Actions Custom',
  ...
  },
  {
    ...
    description: 'Swipe Actions Autoclose',
  ...
  },
  {
    ...
    description: 'Swipe Actions Dynamic',
  ...
  },
  {
    ...
    description: 'Swipe Actions Desktop Fallback',
